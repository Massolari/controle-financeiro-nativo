...
<GridLayout rows="auto, *" class="sidedrawer sidedrawer-left">
            <StackLayout row="0" class="sidedrawer-header">
                ...
                <Label class="sidedrawer-header-brand" text="Meus gastos"></Label>
                <Label class="footnote" text="Gerencie seus gastos"></Label>
            </StackLayout>
            ...
            <ScrollView row="1" class="sidedrawer-content">
                <StackLayout>
                    <GridLayout columns="auto, *" :class="'sidedrawer-list-item' + (selectedPage === 'Home' ? ' selected': '')" @tap="onNavigationItemTap(Home)">
                        ...
                        <Label col="1" text="Gastos" class="p-r-10"></Label>
                    </GridLayout>
